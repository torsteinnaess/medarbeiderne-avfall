...
export default function ConfirmationScreen() {
  ...
  const needsPassword = useAuthStore(
    (s) => s.user?.user_metadata?.needs_password === true,
  );
          ...
          {isWaiting && (
            <>
              ...
              <Text fontSize={14} color="$textSecondary" textAlign="center">
                Betalingen din behandles. Dette tar vanligvis bare noen
                sekunder.
              </Text>
            </>
          )}
